    ...
    <Box display="flex" justifyContent="space-between" >
      <Box sx={{width:'60%'}}>
        ...
        <ButtonGroup sx={{mt:3}}>
            ...
            <Button onClick={() => counterStore.increment()} variant="contained" color="success">İncrement</Button>
            <Button onClick={() => counterStore.increment(5)} variant="contained" color="primary">İncrement by 5</Button>
        </ButtonGroup>
      </Box >
